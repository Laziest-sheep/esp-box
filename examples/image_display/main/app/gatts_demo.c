...
void gatts_init(void)
{
    ...
    // uint8_t indicate_data[8] = {0};
    // while(1)
    // {
        
    //     indicate_data[0]++;
    //     esp_ble_gatts_send_indicate(gl_profile_tab[0].gatts_if, gl_profile_tab[0].conn_id, gl_profile_tab[PROFILE_A_APP_ID].char_handle,
...
void bt_led_set(uint8_t on_off)
{
    uint8_t indicate_data[8] = {0};
    if(on_off == 0)
    {
    ...
    esp_ble_gatts_send_indicate(gl_profile_tab[0].gatts_if, gl_profile_tab[0].conn_id, gl_profile_tab[PROFILE_A_APP_ID].char_handle, sizeof(indicate_data), indicate_data, false);
}
