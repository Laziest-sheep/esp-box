...
static const sr_cmd_t g_default_cmd_info[] = {
    // // English
    {TURN_ON_THE_LIGHT, SR_LANG_EN, 0, "Turn On the Light", "TkN nN jc LiT", {NULL}},
    {TURN_OFF_THE_LIGHT, SR_LANG_EN, 0, "Switch On the Light", "SWgp nN jc LiT", {NULL}},
    {MY_SELF, SR_LANG_EN, 0, "Switch Off the Light", "SWgp eF jc LiT", {NULL}},
    ...
    // Chinese
    {TURN_ON_THE_LIGHT, SR_LANG_CN, 0, "打开电灯", "da kai dian deng", {NULL}},
    {TURN_OFF_THE_LIGHT, SR_LANG_CN, 0, "关闭电灯", "guan bi dian deng", {NULL}},
    {MY_SELF, SR_LANG_CN, 0, "你是笨蛋", "ni shi ben dan", {NULL}},
...
esp_err_t app_sr_modify_cmd(uint32_t id, const sr_cmd_t *cmd)
{
    ...
    // ESP_RETURN_ON_FALSE(NULL != it, ESP_ERR_NOT_FOUND, TAG, "can't find cmd id:%d", cmd->id);    //数据类型对不上，一直报错
    return ESP_OK;
}
